...
sickle = Sickle('https://scholarworks.iu.edu/dspace-oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='com_2022_14076')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://scholarworks.iu.edu/" + hrefValue
