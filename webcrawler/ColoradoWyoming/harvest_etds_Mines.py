...
sickle = Sickle('https://mountainscholar.org/oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='com_10217_100532')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://mountainscholar.org" + hrefValue
