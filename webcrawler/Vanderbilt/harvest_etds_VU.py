...
sickle = Sickle('https://ir.vanderbilt.edu/oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='com_1803_9598')
...
def getPDFdownloadUrl(soup):
    ...
    if anchortag:
        ...
        hrefValue = "https://ir.vanderbilt.edu" + hrefValue
...
for record in records:
    ...
    files = tree.xpath('//dim:field[@qualifier="uri"]', namespaces={'dim': 'http://www.dspace.org/xmlns/dspace/dim'})
