...
def extract_all_field(soup):
    ...
    # Advisor @Dennis
    advisor_list = []
    advisor_elelments = soup.find_all('meta',{'name':'advisor'})
    ...
    # University
    university = soup.find('meta',{'name':'bepress_citation_dissertation_institution'})
    ...
    # Language
    language = soup.find('meta',{'name':"language"})
    ...
    if department is not None:
        department = department.find('p')
    if department:
        department = department.get_text()

    # Discipline
    discipline = soup.find('div',{'id':"beta-disciplines"})
    if discipline is not None:
        discipline = discipline.find('a')
    if discipline:
