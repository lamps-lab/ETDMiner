...
sickle = Sickle('https://repositories.lib.utexas.edu/oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='com_2152_4')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://repositories.lib.utexas.edu" + hrefValue
