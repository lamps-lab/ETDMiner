...
def insertETDs(soup):
    ...
    # Degree
    degree = soup.find('dim:field',{'qualifier':'department', 'element':'degree'})
...
def insertPDFs(soup, etdid, etdPath):
    ...
    urlInitials = 'https://repositories.lib.utexas.edu/bitstream/handle/'
    url = soup.find('dim:field',{'qualifier':'uri'})
    url = url.get_text()
