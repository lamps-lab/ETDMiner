...
sickle = Sickle('https://calhoun.nps.edu/oai/request?')
records = sickle.ListRecords(metadataPrefix='dim', set='com_10945_16')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://calhoun.nps.edu/" + hrefValue
