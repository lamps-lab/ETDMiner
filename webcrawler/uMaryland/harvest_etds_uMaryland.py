...
sickle = Sickle('https://drum.lib.umd.edu/oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='com_1903_2')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://drum.lib.umd.edu" + hrefValue
