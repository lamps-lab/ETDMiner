...
sickle = Sickle('https://oaktrust.library.tamu.edu/dspace-oai/request')
records1 = sickle.ListRecords(metadataPrefix='dim', set='col_1969.1_2')
# Dennis add Digitized Theses and Dissertations (1922–2004) [col_1969.1_129207] 25022
records2 = sickle.ListRecords(metadataPrefix='dim', set='col_1969.1_129207')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://oaktrust.library.tamu.edu" + hrefValue
