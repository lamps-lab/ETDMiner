...
sickle = Sickle('https://athenaeum.libs.uga.edu/oai/request?')
records = sickle.ListRecords(metadataPrefix='dim', set='col_10724_20051')
...
def getPDFdownloadUrl(soup):
    print(soup)
    hrefValue = None
    findClass = soup.find('div', {'class':'mat-list-item-content'})
    print(findClass)
    if findClass:
        ...
        if anchortag:
            ...
            print(hrefValue)
            #hrefValue = "https://scholarship.rice.edu" + hrefValue
...
for record in records:
    ...
    for url in files:
        ...
        if "purl.galileo.usg.edu" not in etdLandingPage:
