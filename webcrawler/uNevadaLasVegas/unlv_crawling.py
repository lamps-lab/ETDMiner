...
base = "https://digitalscholarship.unlv.edu/thesesdissertations/"
not_found = 0
...
def isItemThesis(soup):
    ...
    if ("Theses and Dissertations" in contentTypes[1].text and length is 3):
        isThesis = True
