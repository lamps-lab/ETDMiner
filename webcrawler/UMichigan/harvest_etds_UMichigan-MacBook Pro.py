...
sickle = Sickle('https://deepblue.lib.umich.edu/dspace-oai/request')
records = sickle.ListRecords(metadataPrefix='dim', set='col_2027.42_39366')
...
def getPDFdownloadUrl(soup):
    ...
    if findClass:
        ...
        if anchortag:
            ...
            hrefValue = "https://deepblue.lib.umich.edu/" + hrefValue
